 ...
 * - VK practice history (completed sequences, current sequence)
 * - Practice preferences (intensity, duration, time)
 ...
 * - Practice-history tracking with helper methods
...
// METHOD: Check if the user can access a specific level
userSchema.methods.canAccessLevel = () => {
	return true;
};
