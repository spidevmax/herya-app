...
export const searchPoses = (q, params) => api.get("/poses/search", { params: { q, ...params } });
export const getPosesByCategory = (category, params) => api.get(`/poses/category/${category}`, { params });
