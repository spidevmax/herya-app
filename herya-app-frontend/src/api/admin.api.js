...
export const getUserAnalytics = (userId) =>
	api.get(`/admin/analytics/users/${userId}`);
...
export const updateSequence = (id, data) =>
	api.put(`/admin/sequences/${id}`, data);
export const deleteSequence = (id) => api.delete(`/admin/sequences/${id}`);

// Breathing pattern management
export const createBreathingPattern = (data) =>
	api.post("/admin/breathing-patterns", data);
export const updateBreathingPattern = (id, data) =>
	api.put(`/admin/breathing-patterns/${id}`, data);
export const deleteBreathingPattern = (id) =>
	api.delete(`/admin/breathing-patterns/${id}`);
