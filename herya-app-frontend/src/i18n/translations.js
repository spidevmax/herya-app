export const translations = {
	en: {
		...
		library: {
			...
			chakras: {
				muladhara: "Muladhara (root)",
				svadhisthana: "Svadhisthana (sacral)",
				manipura: "Manipura (solar plexus)",
				anahata: "Anahata (heart)",
				vishuddha: "Vishuddha (throat)",
				ajna: "Ajna (third eye)",
				sahasrara: "Sahasrara (crown)",
			},
			transitions: {
				static: "Static",
				dynamic: "Dynamic",
			...
			drishti: {
				...
				none: "Neutral gaze",
				padayoragrai: "Toes",
				parshva_drishti: "To the side",
				urdhva_drishti: "Upwards",
			},
			technique_families: {
				heating: "Heating",
				cooling: "Cooling",
		...
		pose_detail: {
			...
			sidedness_values: {
				...
				left_only: "Left side only",
				right_only: "Right side only",
			},
		...
		practice: {
			...
			checkin_subtitle: "Take a moment to notice how you arrive.",
	...
	es: {
		...
		dashboard: {
			...
			admin_quick_actions: "Acciones rápidas de administración",
		...
		library: {
			...
			effects: {
				...
				cooling: "Refrescante",
				heating: "Calentante",
				grounding: "Enraizante",
			},
			chakras: {
				muladhara: "Muladhara (raíz)",
				svadhisthana: "Svadhisthana (sacro)",
				manipura: "Manipura (plexo solar)",
				anahata: "Anahata (corazón)",
				vishuddha: "Vishuddha (garganta)",
				ajna: "Ajna (tercer ojo)",
				sahasrara: "Sahasrara (corona)",
			},
			transitions: {
				static: "Estática",
				dynamic: "Dinámica",
			...
			drishti: {
				angushta_madhyai: "Pulgares",
				brumadhya: "Entrecejo",
				hastagrai: "Mano",
				nabi_chakra: "Ombligo",
				nasagrai: "Punta de la nariz",
				none: "Mirada neutra",
				padayoragrai: "Dedos de los pies",
				parshva_drishti: "Hacia un lado",
				urdhva_drishti: "Hacia arriba",
			},
			technique_families: {
				heating: "Calentante",
				cooling: "Refrescante",
				...
				humming: "Zumbido",
				ujjayi_family: "Ujjayi",
				alternate_nostril: "Nariz alterna",
			},
			categories: {
				standing: "De pie",
		...
		pose_detail: {
			...
			sidedness_values: {
				...
				left_only: "Solo lado izquierdo",
				right_only: "Solo lado derecho",
			},
		...
		journal_form: {
			...
			gratitude: "Qué ayudó",
			gratitude_subtitle: "Una persona, cosa o momento que apoyó tu práctica.",
			gratitude_placeholder: "Una persona, cosa o momento",
			photos: "Fotos",
		...
		practice: {
			...
			checkin_subtitle: "Tómate un momento para notar cómo llegas.",
