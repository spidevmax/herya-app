			...
			<div className="flex items-center gap-3 flex-1 p-4 min-w-0">
				...
				<div className="flex-1 min-w-0">
					<div className="flex items-start gap-2 mb-1">
						<h3 className="font-display font-semibold text-[#1A1A2E] text-sm leading-tight truncate">
							{sequence.englishName}
						</h3>
						{sequence.level && (
							<Badge color={family.color} className="flex-shrink-0 text-[10px]">
								L{sequence.level}
							</Badge>
						)}
					</div>
					<p className="text-[#9CA3AF] text-xs italic mb-2 truncate">
